...
class AutoCompleteField extends Component {
    ...
    render() {
        ...
        if (
            this.props.optionsList === undefined ||
        ...
        console.log(
            '[TA] TypeAhead Component: Props: ',
            currentOptionsList.data
        )

        return (
            <Form.Group as={Col} md={this.props.sm}>
                ...
                <Typeahead
                    ...
                    defaultSelected={currentOptionsList.data.filter(
                        item => item.id === defaultItem
                    )}
                />
            </Form.Group>
        )
